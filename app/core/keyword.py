...
feedback_guide: dict[str, dict[str, str]] = {
    ...
    "차분한": {
        "desc": "자극이 적고 안정적인 구도, 부드러운 색감과 평온한 분위기",
    },
    "활기찬": {
        "desc": "움직임이 느껴지는 피사체, 역동적인 구도, 에너지가 있는 장면",
    },
    "자연적인": {
        "desc": "식물, 하늘, 물, 흙 등 자연 요소 중심의 장면",
    },
    "옛스러운": {
        "desc": "빈티지한 구조물, 전통적 재료나 오래된 질감을 담은 장면",
    },
    "신비로운": {
        "desc": "빛과 그림자 대비가 강하거나 몽환적·비현실적 느낌의 장면",
    },
    "웅장한": {
        "desc": "스케일이 크고 압도적 공간감이 드러나는 장면",
    },
}
