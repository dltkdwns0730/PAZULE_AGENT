"""User-facing REST API routes for mission workflow and coupon lifecycle."""
...
@user_api.route("/api/preview", methods=["POST"])
...
@user_api.route("/api/mission/start", methods=["POST"])
...
@user_api.route("/api/mission/submit", methods=["POST"])
...
@user_api.route("/api/coupon/issue", methods=["POST"])
...
@user_api.route("/api/coupon/redeem", methods=["POST"])
...
@user_api.route("/api/user/stats", methods=["GET"])
...
@user_api.route("/api/user/reset", methods=["POST"])
...
@user_api.route("/api/coupons", methods=["GET"])
