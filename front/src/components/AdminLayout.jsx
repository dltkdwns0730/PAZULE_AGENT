...
const navItems = [
  { to: '/admin', label: '대시보드', icon: BarChart3, end: true },
  { to: '/admin/logs', label: '미션 로그', icon: ClipboardList },
    ...
    <div className="min-h-screen bg-slate-100 text-slate-950">
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col bg-admin-primary text-white md:flex">
        <div className="p-6">
          ...
          <h1 className="mt-2 text-xl font-black">관리자 콘솔</h1>
        </div>
        ...
        <div className="border-t border-white/10 p-4">
          <p className="truncate text-sm font-semibold">{email || '관리자'}</p>
          <button
            type="button"
      ...
      <main className="min-h-screen md:ml-64">
        <div className="border-b border-slate-200 bg-white px-5 py-4 md:hidden">
          <p className="text-sm font-black text-admin-primary">PAZULE 관리자</p>
