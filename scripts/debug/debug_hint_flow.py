...
def debug_hint_flow():
    ...
    start_res = requests.post(f"{BASE_URL}/api/mission/start", json={
        "user_id": user_id,
    ...
    with open(test_img_path, "rb") as f:
        submit_res = requests.post(f"{BASE_URL}/api/mission/submit", data={
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.error("Server is not running on 8080. Please run 'python main.py' first.")
