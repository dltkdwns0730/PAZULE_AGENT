...
def test_single_image(image_path, target_atmosphere):
    ...
    for model_name in models:
        try:
            ...
            res = probe.probe("atmosphere", image_path, target_atmosphere, prompt_bundle)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mood", default="화사한", help="테스트할 분위기 키워드 (기본값: 화사한)")
