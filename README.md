...
=======
전체 스키마는 [`api-specification.md`](./docs/api-specification.md)를 참고하세요.
>>>>>>> Stashed changes
...
=======
| [Changelog](./docs/changelog.md) | 버전별 변경 이력 (v1 수상작 ~ v2 현재) |
| [Architecture](./docs/architecture.md) | 하네스 설계, 상태 흐름, Council 에스컬레이션 상세 |
| [SigLIP2 Benchmark](./docs/benchmarks/siglip2-v1-baseline.md) | 모델 성능 벤치마크 (프롬프트 언어 비교) |
| [Pipeline Diagram](./docs/pipeline-visualization.md) | Mermaid 파이프라인 다이어그램 |
| [API Specification](./docs/api-specification.md) | 엔드포인트 요청/응답 스키마 |
| [상용화 전략](./docs/commercialization-plan.md) | 프로덕션 전환 설계 |
| [Documentation Guide](./docs/doc-guide.md) | 문서 작성 형식 및 관리 규칙 |
>>>>>>> Stashed changes
